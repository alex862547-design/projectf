...
// ตารางสายการแข่งขัน (bracket) ของกีฬาชนิดหนึ่ง — ใช้ในหน้า "ตารางแข่งขัน" ของนักศึกษา (MatchSchedule)
// และหน้าเยี่ยมชม (GuestView) รับ `matches` ที่กรองมาแค่กีฬาที่กำลังดูอยู่แล้วจากภายนอก ตัวนี้แค่จัดวาง
// ให้ตรงตำแหน่งตามค่า `round` ของแต่ละแมตช์ (สายการแข่งขันแบบ 4 ทีมคัดออกสายเดียว เข้ากับจำนวนสีในระบบพอดี):
// รอบรองชนะเลิศ 2 นัด -> รอบชิงชนะเลิศ 1 นัด และแยก รอบชิงอันดับ 3 ไว้ต่างหาก แล้ววาดกล่อง "การจัดอันดับ"
// สรุปอันดับ 1-4 จากผลจริงต่อท้ายให้ด้วย
